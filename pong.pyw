...
class Scorekeeper:
    ...
    def display(self):
        text = font.render("{}   {}".format(self.scores[0], self.scores[1]), True, (255, 255, 255))
        root.blit(text,(DISP_WIDTH//2 - text.get_width() // 2, 50 - text.get_height() // 2))
...
while not done:
    ...
    if pressed[pygame.K_w]: player1.move('up')
